  ...
  return (
    <div className="landing-root">
      ...
      <div className="cta-block">
        <a href="https://vk.com/@illusion_real-illuziya-realnosti-glava-1-podarok-ot-predatelya" target="_blank" rel="noopener noreferrer" className="btn btn-red">Читать книгу</a>
